...
The terminal covers five asset classes across 12 channels: equities (live index pricing, market movers, analyst ratings), crypto (liquidation maps, whale alerts, fear and greed, ETF flows, orderflow), forex (7 major pairs, CFTC COT positioning, central bank rates), options (unusual flow, GEX dealer positioning, gamma squeeze radar), and macro (full yield curve, 18 FRED indicators, FOMC rate probabilities, economic calendar). Filings and research are also included: congressional trades, insider Form 4s, 13F institutional holdings, and social sentiment.
