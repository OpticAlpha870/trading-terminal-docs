...
The terminal covers six asset classes across 20+ channels: equities (live index pricing, market movers, analyst ratings, 13F ownership crowding via Capital Network), crypto (liquidation maps, whale alerts, fear and greed, ETF flows, orderflow, perpetual futures funding and open interest, whale-wallet cohorts, corporate treasury holdings), forex (7 major pairs, CFTC COT positioning, central bank rates), options (unusual flow, GEX dealer positioning, gamma squeeze radar), macro (full yield curve, 18 FRED indicators, FOMC rate probabilities, economic calendar), and Kalshi prediction markets (implied probability, order book depth, term structure). Filings and research are also included: congressional trades, insider Form 4s, 13F institutional holdings, and social sentiment. News channel provides market headlines, economic calendar, and FedWatch probabilities.
...
Unusual Whales focuses on options flow and dark pools with no forex, macro, or crypto market structure coverage. SpotGamma focuses on GEX and dealer positioning for equities only. OpticAlpha covers all of it in one workspace at $10.50/month on the annual plan, versus $50/month for Unusual Whales and $99/month for SpotGamma. See the full [platform comparison](channel-comparison).
